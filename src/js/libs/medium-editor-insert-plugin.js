...
;(function ($, window, document, undefined) {
    ...
    Core.prototype.toggleButtons = function (e) {
        ...
        if ($el.hasClass('medium-editor-placeholder') === false && $el.closest('.medium-insert-buttons').length === 0 && $current.closest('.medium-insert-buttons').length === 0) {
            ...
            if (this.options.editor.isInsertingImage &&/*isInsertingImage &&*/ $p.length && (($p.text().trim() === '' && !activeAddon) || activeAddon === 'images')) {
                ...
                setTimeout(function () {
                    ...
                    that.$el.find(".medium-insert-buttons-show").trigger("click");
                    that.options.editor.setIsInserting(false);
                }, activeAddon ? 100 : 0);
            } else {
                this.hideButtons();
            }
    ...
    Core.prototype.toggleAddons = function () {
        ...
        this.$el.find(".medium-insert-action").eq(0).trigger("click");
    };
    ...
    var pluginName = 'mediumInsert',
        ...
        defaults = {
            ...
            fileUploadOptions: { // See https://github.com/blueimp/jQuery-File-Upload/wiki/Options
                url: 'http://file.qujieyou.vocinno.com/session/image/qujieyou',
                send:{token:getCookie("token")},
...
//                    888                          888
// 888  888 888-~88e  888  e88~-_    /~~~8e   e88~\888
// 888  888 888  888b 888 d888   i       88b d888  888
// 888  888 888  8888 888 8888   |  e88~-888 8888  888
// 888  888 888  888P 888 Y888   ' C888  888 Y888  888
// "88_-888 888-_88"  888  "88_-~   "88_-888  "88_/888
//          888
    ...
    Images.prototype.uploadDone = function (e, data) {
        var $el = $.proxy(this, 'showImage', "http://file.qujieyou.vocinno.com/image/qujieyou/"+data.result[0].id, data)();
...
// ,e,                               /                                  888                     d8   ,e,
//  "  888-~88e-~88e   /~~~8e  e88~88e  e88~~8e         d88~\  e88~~8e  888  e88~~8e   e88~~\ _d88__  "   e88~-_  888-~88e
// 888 888  888  888       88b 888 888 d888  88b       C888   d888  88b 888 d888  88b d888     888   888 d888   i 888  888
// 888 888  888  888  e88~-888 "88_88" 8888__888        Y88b  8888__888 888 8888__888 8888     888   888 8888   | 888  888
// 888 888  888  888 C888  888  /      Y888    ,         888D Y888    , 888 Y888    , Y888     888   888 Y888   ' 888  888
// 888 888  888  888  "88_-888 Cb       "88___/        \_88P   "88___/  888  "88___/   "88__/  "88_/ 888  "88_-~  888  888
//                              Y8""8D

            MediumEditor.selection.selectNode.call(that.core.options.editor, $image[0], that.core.options.editor.options.ownerDocument);
